...
let fruits_name : string[] = ["apple", "banana", "mango", "orange"];
...
let fruit_name: string[] = ["apple", "banana", "mango", "orange"];
...
let fruitt :string[] = ["apple", "banana", "mango", "orange"];
...
let add_fruit :string[] =["CusterdFruit","dragonFruit","pineApple","mango","papaya"];
...
let fruiit : string[] = ["CusterdFruit","dragonFruit","pineApple","mango","papaya","kiwi"]
...
let frits1: string[] = ["apple", "banana", "mango", "orange"];
...
let citrusFruits : string[] = ["orange","lemon","apple","mango","kiwi"];

let citrusFruit : string[] = citrusFruits.splice(0,2)
...
let lastTwoFruits : string[] = ["orange","lemon","apple","mango","kiwi"];

let TwoFruits : string[] = lastTwoFruits.splice(0,3)
